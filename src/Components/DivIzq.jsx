        ...
        <div className="w-full mb-6 lg:mb-0 mx-auto relative text-center px-6 rounded-[20px] mt-[180px] md:mt-[220px] lg:mt-0">
            ...
            <div className="pt-[100px]">
                ...
                <button className="downloadBtn">
                  ...
                  <a href={idioma === 'EN' ? "./Assets/CV Juan Perez.pdf" : "./Assets/JEPA-CV.pdf"} target="_blank" rel="noopener noreferrer" download="JuanPérez.pdf" className='text-white'>{lenguaje.download_cv[`${idioma}`]}</a>
                </button>
            </div>
        </div>
      </section>
