...
const Home = ({idioma, setIdioma}) => {
  return (
    <>
    <div className="flex flex-col items-center pt-[0vh] lg:pt-[10vh] h-[100vh] md:h-[90vh] lg:h-[80vh] xl:h-[71vh] justify-center aos-init aos-animate" data-aos="fade">
        ...
        <h3 className="sm:hidden mt-6 mb-1 text-4xl font-semibold darkMode" style={{"textAlign":"center"}}>Juan Esteban</h3>
        <h3 className="sm:hidden text-4xl font-semibold darkMode" style={{"textAlign":"center"}}>Pérez Aguas</h3>
