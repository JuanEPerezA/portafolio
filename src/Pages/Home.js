...
const Home = ({idioma, setIdioma}) => {
  return (
    <>
    <div className="flex flex-col items-center pt-[0vh] lg:pt-[10vh] h-[100vh] md:h-[90vh] lg:h-[80vh] xl:h-[71vh] justify-center aos-init aos-animate" data-aos="fade" style={{"justifyContent": "normal"}}>
        ...
        <h3 className="hidden sm:ml-6 sm:block mt-6 mb-1 text-5xl font-semibold darkMode" style={{"textAlign":"center"}}>Juan Esteban Pérez Aguas</h3>
        <h6 className="hidden sm:ml-6 sm:block mb-4 text-2xl text-[#7B7B7B]" style={{"textAlign":"center"}}>{lenguaje.cargo[`${idioma}`]}</h6>
        <h3 className="sm:hidden mt-6 mb-0.5 text-4xl font-semibold darkMode" style={{"textAlign":"center"}}>Juan Esteban</h3>
        <h3 className="sm:hidden mb-4 text-4xl font-semibold darkMode" style={{"textAlign":"center"}}>Pérez Aguas</h3>
        <h6 className="sm:hidden mb-4 text-2xl text-[#7B7B7B]" style={{"textAlign":"center"}}>{lenguaje.cargo[`${idioma}`]}</h6>
